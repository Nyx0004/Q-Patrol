...
> **Live Demo:** [Open Q-Patrol on Streamlit](PASTE-YOUR-STREAMLIT-LINK-HERE)
...
│              Streamlit Interface            │
│                                             │
│  City Selection │ Map │ QAOA │ SOS │ Report│
└──────────────────────┬──────────────────────┘
                       │
          ┌────────────┼─────────────┐
          │            │             │
          ▼            ▼             ▼
     Risk/Data      QUBO + QAOA     OSRM
     Processing     Optimization    Routing
          │            │             │
          └────────────┼─────────────┘
                       ▼
                Dispatch Results
...
git clone https://github.com/YOUR-USERNAME/Q-Patrol.git
cd Q-Patrol
